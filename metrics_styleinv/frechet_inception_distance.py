...
def compute_fid(opts, max_real, num_gen):
    ...
    opts.dataset_kwargs.return_vid = False
    opts.dataset_kwargs.return_one = True
    opts.dataset_kwargs.random_select = True
    ...
    if opts.generator_as_dataset:
        ...
        gen_opts.dataset_kwargs.return_vid = False
        gen_opts.dataset_kwargs.return_one = True
        gen_opts.dataset_kwargs.random_select = False
    ...
    fid = m + metric_utils.trace_calculator(sigma_real, sigma_gen)
    return float(fid)
